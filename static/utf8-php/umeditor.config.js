...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义 fullscreen（全屏） formula  drafts  preview
        , toolbar: [
...
//          ]
        ...
        , whiteList: {
            ...
            video: ['autoplay', 'controls', 'loop', 'preload', 'src', 'height', 'width', 'style', 'class', 'id', 'webkit-playsinline', 'playsinline']
        }
    };
})();
