<template>
  <div class="xk-container">
    <div class="xk-radius">
      ...
      <div class="content">
        <el-button :size="$size" type="primary" @click="selfMallCategory">确定</el-button>
        <el-button :size="$size" type="plain" @click="selfMallCategory">取消</el-button>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      selfMallCategory() {
        this.$router.push({ path: "/selfMallCategory" });
      }
    },
    components: {
      ImageUpload
