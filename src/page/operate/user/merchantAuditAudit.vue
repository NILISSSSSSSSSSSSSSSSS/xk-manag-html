    ...
    <div class="xk-container">
        ...
        <div class="xk-radius">
            ...
            <div class="pubpadd" v-loading="loading">
                ...
                <el-card class="box-card margintop20"
                         v-if="this.merchantType === 'MERCHANT' || this.merchantType === 'PARTNER'">
                    <div slot="header" class="clearfix">
                        <span>店铺信息：</span>
                    </div>
                    <div class="paddBoth">
                        ...
                        <el-row class="paddtop20" v-if="this.merchantType === 'MERCHANT'">
                            ...
                            <el-col v-if="merchantAuditData.shopPhotos === undefined || merchantAuditData.shopPhotos.length == 0"
                                    :span="4">暂无店铺店内照片
                            </el-col>
                ...
                <el-card class="box-card margintop20">
                    ...
                    <div class="paddBoth">
                        <el-row type="flex" justify="space-between" class=" paddtop20">
                            <el-col>主推城市：
                                <span v-for="code in merchantAuditData.mainCities" :key="code">
                            {{getCitys(code.provinceCode, code.cityCode, code.districtCode)}}&nbsp;</span></el-col>
                ...
                <el-card class="box-card margintop20">
                    ...
                    <div class="paddBoth">
                        <el-row type="flex" justify="space-between">
                            ...
                            <el-col>
                                <el-input v-if="auditStatus === 'FAILED'" type="textarea" placeholder="请输入不通过原因"
    ...
    export default {
        ...
        methods: {
            ...
            getCitys(pCode, cCode, dCode) { // 获取主推城市
                let districts = new Map(JSON.parse(window.localStorage.getItem("xk-district"))); // 区县
                let provinces = new Map(JSON.parse(window.localStorage.getItem("xk-province"))); // 省
                let citys = new Map(JSON.parse(window.localStorage.getItem("xk-city"))); // 市
                let provinceName = provinces.get(pCode) ? provinces.get(pCode).name : "";
                let cityName = citys.get(cCode) ? citys.get(cCode).name : "";
                let districtName = districts.get(dCode) ? districts.get(dCode).name :"";
