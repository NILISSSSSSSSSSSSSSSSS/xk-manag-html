            ...
            <el-card class="box-card">
                ...
                <div class="paddBoth">
                    ...
                    <el-row  class=" paddtop20">
                        ...
                        <el-col :span="6" v-if="!storeDetails.detail.contactPhones || storeDetails.detail.contactPhones.length == 0" >暂无电话</el-col>
                        ...
                        <el-col :span="4" v-if="!storeDetails.detail.businessTime || JSON.stringify(storeDetails.detail.businessTime) == '{}'">暂无营业时间</el-col>
  ...
  export default {
      ...
      methods: {
        ...
        storeAudit() { // 审核
            ...
            let paramList = {
                id: id,
                firstAuthStatus: this.status,
                msg: this.message
            }
            console.log(paramList)
            this.$http.get(this.$api.mShopAuth, paramList, true)
            .then(res => {
                console.log(res)
                this.$message.success("店铺审核完成")
                this.$router.push({path: "/storeAudit"});
            })
            .catch(err => {
                this.$message.error("店铺审核失败")
                this.$router.push({path: "/storeAudit"});
            })
        }
      }
