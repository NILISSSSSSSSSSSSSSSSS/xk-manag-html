    ...
    <!--搜索头-->
      ...
      <div class="xk-radius margintop20">
        <div class='xk-title'>
          ...
          <div class="vus-btn">
          <el-button type="primary" size="small" @click="openBranch" v-permission="'merchantsSemicolonSearch'">分号查询</el-button>
        </div>
            <div class="vus-bottom"></div>
        </div>
...
export default {
    ...
    methods: {
     ...
     isMerchant(val) {
      ...
      goReconmmend(code) {
        console.log(code)
        this.$router.push({path: '/reconmmendDetail', query: {code: code}})
      }
    },
    components: {
        ProvinceCascader
