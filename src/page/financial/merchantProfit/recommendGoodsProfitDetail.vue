<template>
    <div class="recommend-goods-profit-detail xk-container">
        <div class="xk-radius">
            <div class='xk-title'>
                <div class="vus-title">
                    <span></span>查询
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="联盟商ID：">
                            <el-input v-model="searchForm.merchantId" :size="$size" placeholder="请输入联盟商ID">
                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="联盟商名称：">
                            <el-input v-model="searchForm.name" :size="$size" placeholder="请输入联盟商名称">
                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
        ...
        <div class="xk-radius marintop20">
            ...
            <el-table :data="tableData">
                ...
                <el-table-column label="联盟商名称"></el-table-column>
                <el-table-column label="推荐商品销售金额"></el-table-column>
                <el-table-column label="平台纯利润"></el-table-column>
                <el-table-column label="推荐收益"></el-table-column>
                <el-table-column label="区域维护补贴"></el-table-column>
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button :size='$size' type="text">查看详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
