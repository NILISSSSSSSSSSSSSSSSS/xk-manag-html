<template>
    <div class="lottery-failed" v-if="dialogVisible">
        <el-dialog :visible.sync="dialogVisible" title="兑奖失败详情" width="900px" :before-close="handleClose">
            <el-form ref="form" :model="form" label-width="180px" v-loading="loading">
                ...
                <div style="padding-left:120px">
                    <el-steps direction="vertical" :active="5" finish-status="success" :space="50">
                        <el-step :title="'选号时间'+Moment(form.waitForInvoiceTime*1000).format('YYYY-MM-DD HH:mm:ss')">
                        </el-step>
                        ...
                        <el-step :title="'兑奖失败'+Moment(form.claimPrizeOverTime*1000).format('YYYY-MM-DD HH:mm:ss')">
                        </el-step>
